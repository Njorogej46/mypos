...
class Unit extends CI_Controller
{
    ...
    public function save()
    {
        ...
        $this->session->set_flashdata('message', 'Data Unit added succesfully.');
        redirect('unit');
    }
    ...
    public function update()
    {
        ...
        $this->session->set_flashdata('message', 'Data Unit update succesful.');
        redirect('unit');
    }
    ...
    public function delete()
    {
        ...
        $this->session->set_flashdata('message', 'Data Unit delete successful!');
        redirect('unit');
    }
}
