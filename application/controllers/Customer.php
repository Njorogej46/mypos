...
class Customer extends CI_Controller
{
    ...
    public function cek_customer()
    {
        ...
        $return_data = ($cek_data) ? "ADA" : "Not found";
    ...
    public function save()
    {
        ...
        $this->session->set_flashdata('message', 'Customer data successfully added.');
        redirect('customer');
    }
    ...
    public function update()
    {
        ...
        $this->session->set_flashdata('message', 'Customer data successfully updated.');
        redirect('customer');
    }
    ...
    public function delete()
    {
        ...
        $this->session->set_flashdata('message', 'Customer data successfully deleted.');
        redirect('customer');
    }
}
