...
class Category extends CI_Controller
{
    ...
    public function save()
    {
        ...
        $this->session->set_flashdata('message', 'Data Categories added successfully.');
        redirect('category');
    }
    ...
    public function update()
    {
        ...
        $this->session->set_flashdata('message', 'Data Categories updated successfully.');
        redirect('category');
    }
    ...
    public function delete()
    {
        ...
        $this->session->set_flashdata('message', 'Data Categories deleted successfully.');
        redirect('category');
    }
}
