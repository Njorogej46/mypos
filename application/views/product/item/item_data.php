                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="nama_produk" class="col-form-label">Product Name <font color="#f00">*</font></label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                                    ...
                                    <div class="form-row" id="input_photo" style="display:none;">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="image" class="col-form-label">Photo Product</label>
                                        </div>
                            ...
                            <tbody>
                                ...
                                foreach ($item as $i) { ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <img src="<?= base_url('/uploads/product/' . $i->image) ?>" style="width: 50px; height:50px;">
                                        </td>
                                        <td><?= $i->stock; ?></td>
    ...
    function editData(item_id) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $('#photo_url').val(result['image']);
                $('#image_lama').val(result['image']);
                $('#input_photo').hide();
                $('#edit_photo').show();
